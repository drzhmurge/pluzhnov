...
class N2GeneratorEventsManagerEvents extends N2GeneratorAbstract {
    ...
    public function renderFields($form) {
        ...
        $customVariables = new N2ElementGroup($_filter, 'custom', n2_('Custom variables'));
        new N2ElementText($customVariables, 'date_variables', n2_('Format date variables'), '', array( 'tip' => 'With the WordPress Settings -> General -> Timezone and Date format, new variables will be generated from the given variables. Separate them with comma.' ));
