...
class N2SmartsliderSlidesModel extends N2Model {
    ...
    public function simpleEditForm($data = array()) {
        ...
        if (!$this->slider->isStaticEdited || (!isset($data['static-slide']) || $data['static-slide'] != 1)) {
            ...
            new N2ElementOnOff($slideVideoBackground, 'backgroundVideoReset', n2_('Reset on slide change'), 0);
        ...
        $publishDates = new N2ElementMixed($settings, 'publishdates', n2_('Published between'), '0000-00-00 00:00:00|*|0000-00-00 00:00:00');
